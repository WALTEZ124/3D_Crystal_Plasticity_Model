...
material_file_elastic_plastic="material_model_elastic_plastic_${used_material}_all_slip_systems.zmat"
...
Zpreload ${material_file_elastic_plastic} > "Zpreload_material_model_elastic_plastic_${used_material}_all_slip_systems.txt"
...
do
	NewJobName="${JobName}_all_slip_systems.inp"
